...
async function mintUSDT() {
  try {
    ...
    // This assumes you have the mint authority for the devnet USDT
    ...
    if (error.message.includes('mint authority')) {
      ...
      console.log('Since you may not have mint authority for this USDT token,');
      console.log('let me create a NEW devnet token that you control...');
    }
  }
}
