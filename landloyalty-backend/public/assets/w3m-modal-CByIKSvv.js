import{Y as x,al as te,R as c,C as ne,c as g,r as j,a as m,i as b,b as d,n as l,z as k,A as z,D as u,e as se,k as f,v as D,y as L,ah as le,a2 as V,E as U,O as R,t as F,g as ce,S as A,_ as T,ae as q,T as de,U as ie,am as ue,an as he}from"./index-Cjo7FgaV.js";import{P as _}from"./index-B5_EtXhI.js";import{S as pe}from"./SwapController-AmQr4AlJ.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
